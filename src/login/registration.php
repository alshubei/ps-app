        ...
        <div class="col-md-4 col-md-offset-4">
            ...
            <div class="login-panel panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <center><b>Already registered ?</b> <br></b><a href="../">Login here</a></center>
                    <!--for centered text-->
                </div>
            </div>
        </div>
...
//insert the user into the database.
    ...
    $insert_user = "insert into users (name,password,email) VALUE ('$user_name','$encrypted_pwd','$user_email')";
